...
//    path = "/home/satyukt/Projects/1056/catModel/page1_table1.csv"
    ...
    d3.csv(path, function(data) {
        ...
        if (d == "") {
            ...
            console.log("dataSet1 table1: "+dataSet1.pop());
            $("#table1").DataTable({
                "aaData": dataSet1,
                "aaSorting": [[0, 'asc']],
                "order":  [ 0, 'asc' ],
...
function chartDispPage2() {
    ...
    d3.csv(path, function(data) {
        ...
        if (d == "") {
            ...
            var x = new Array();
            for (i = 0; i < d3.values(data).lengtreso
            console.log("x:" + x);
...
//    console.log("chartDispPage3, BAR: " + dataSet[4][2]);
