...
<body onload="initLoad()">
        ...
        <div class = "col-md-12" style = "margin-top: 0px; margin-left: 0px;">
            ...
            <div class="row">
                <div class="col-md-12" id="icon_bar">
                    <div class="icon-bar">
                        <div>
                            <a href="resultsNew1.php"><i class="fa fa-refresh" title = "Reload" style="color:rgb(82, 80, 80);" aria-hidden="true"></i></a>
                            <!--<a href="#" onclick="show()"><i class="fa fa-save" style="color:rgb(56, 56, 56);"></i></a>
                            <a href="#"><i class="fa fa-print" style="color:rgb(75, 75, 75);"></i></a>-->
                        </div>
                        <div class="pagin">
            ...
            <div class="page2" id="pg2" style="display: none;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 style="text-align: center;">Gross AEP and OEP</h4>
    ...
    <script src="resources/js/script12345.js"></script>
